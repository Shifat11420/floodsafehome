...
##-----------freeboard construction cost-----------------
    ...
    freeboardCost = []
    for i in range(len(totalBFE)):
        freeboardCost.append(int(round(totalBFE[i] * 0.023 * Building_value,-2)))
...
###----------------Insurance-----------------------------------------
    ...
    ##--------------Avoided annual loss and monthly avoided loss---------------------------------
    annual_avoided_loss = []
    for i in range(len(totalBFE)): 
    ...
    ##-----------------Annual and monthly premium saving------------------------------
