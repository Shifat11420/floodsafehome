jQuery(document).ready(function($){
  ...
  */
  ...
  var freeboard2 = document.getElementById("freeboard");
  var freeboard_array2 = ["{{FreeboardCost0}}", "{{FreeboardCost1}}", "{{FreeboardCost2}}", "{{FreeboardCost3}}", "{{FreeboardCost4}}"];
  function setValue()
  {
  var value2 = obj.value;
  freeboard2.scr = freeboard_array2[value];
  }
